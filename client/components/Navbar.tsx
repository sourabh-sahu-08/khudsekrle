    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-8">
                {isLoggedIn ? (
                    <>
                        <Link href="/dashboard" className="flex items-center gap-2 text-slate-400 hover:text-white transition-all duration-300 font-medium hover:translate-y-[-1px]">
                            <History size={18} />
                            <span>History</span>
                        </Link>
                        <Link href="/profile" className="flex items-center gap-2 text-slate-400 hover:text-white transition-all duration-300 font-medium hover:translate-y-[-1px]">
                            <User size={18} />
                            <span>Profile</span>
                        </Link>
                        <button 
                    ...
                    <>
                        <Link href="/auth/login" className="text-slate-400 hover:text-white transition-colors font-semibold tracking-wide">
                            Sign In
                        </Link>
                        <Link 
                            href="/auth/register" 
